...
// ================= [사용자 추가 코드 시작] =================
// 하드포크할 블록 높이 정의
const MyForkBlockNumber = 1910001

// 나의 새로운 체인 ID 정의 (예: 9999)
var MyChainID = big.NewInt(9999)
// ================= [사용자 추가 코드 끝] =================
...
var (
        ...
        MainnetChainConfig = &goethereum.ChainConfig{
                ...
                BerlinBlock:                   big.NewInt(2_000_000),
                LondonBlock:                   big.NewInt(2_000_000),
                ArrowGlacierBlock:             big.NewInt(2_000_000),
                GrayGlacierBlock:              big.NewInt(2_000_000),
